...
public class UrlDevice {
    ...
    public static class Builder {
         ...
         */
        public Builder(UrlDevice urlDevice) throws JSONException {
         ...
         */
        public Builder setExtra(JSONObject extraData) throws JSONException {
         ...
         * @return the Builder object for chaining operations.
         */
        public Builder addExtra(String key, boolean value) throws JSONException {
         ...
         * @return the Builder object for chaining operations.
         */
        public Builder addExtra(String key, Object value) throws JSONException {
            mNewExtraData.put(key, value);
            return this;
        }
         ...
         */
        public UrlDevice build() throws JSONException {
     ...
     */
    public static UrlDevice jsonDeserialize(JSONObject jsonObject) throws JSONException {
